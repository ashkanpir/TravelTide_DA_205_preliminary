...
--Selecting columns needed to acquire final results, and filtering the data for a certain date condition, as specified by project requirements.
...
--Filtering the data by the second condition the number of sessions.
SessionCounts AS (
    SELECT
        user_id,
